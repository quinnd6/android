...
include_once 'connection.php';
	...
	class TransactionList {
		...
		public function getLastFiveTransactions($userid)
		{
			$query = "SELECT description, price, dateandtime FROM optimus_transactions WHERE userid = '$userid' ORDER BY dateandtime DESC LIMIT 10 ";
		...
		{
			$query = "SELECT description, price, dateandtime FROM optimus_transactions WHERE userid = '$userid' ORDER BY dateandtime DESC LIMIT $numOfTransactions";
			$result = mysqli_query($this->connection, $query);
	...
	$transactionList = new TransactionList();
		...
		//$password = $_POST['password'];
			...
			$transactionList-> getLastFiveTransactions($userid);
